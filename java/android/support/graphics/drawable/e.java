...
public class e implements TypeEvaluator {
    ...
    public Object evaluate(float f, Object obj, Object obj2) {
        ...
        return Integer.valueOf(Math.round(((float) Math.pow((double) (pow3 + ((((float) Math.pow((double) (((float) (intValue2 & 255)) / 255.0f), 2.2d)) - pow3) * f)), 0.45454545454545453d)) * 255.0f) | (Math.round((f2 + ((f6 - f2) * f)) * 255.0f) << 24) | (Math.round(((float) Math.pow((double) (pow + ((((float) Math.pow((double) f7, 2.2d)) - pow) * f)), 0.45454545454545453d)) * 255.0f) << 16) | (Math.round(((float) Math.pow((double) (pow2 + ((((float) Math.pow((double) f8, 2.2d)) - pow2) * f)), 0.45454545454545453d)) * 255.0f) << 8));
    }
}
