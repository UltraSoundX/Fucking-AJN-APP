        ...
        while (i9 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    makeMeasureSpec3 = MeasureSpec.makeMeasureSpec(paddingLeft - i12, ExploreByTouchHelper.INVALID_ID);
                ...
                if (layoutParams.height == -2) {
                    makeMeasureSpec4 = MeasureSpec.makeMeasureSpec(paddingTop, ExploreByTouchHelper.INVALID_ID);
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                if (layoutParams2.width != 0) {
                                    ...
                                    makeMeasureSpec = MeasureSpec.makeMeasureSpec(paddingTop, ExploreByTouchHelper.INVALID_ID);
                            ...
                            if (!z5) {
                                ...
                                makeMeasureSpec2 = MeasureSpec.makeMeasureSpec(paddingTop, ExploreByTouchHelper.INVALID_ID);
                            } else if (layoutParams2.height == -1) {
