...
public class NestedScrollView extends FrameLayout implements NestedScrollingChild2, NestedScrollingParent2, ScrollingView {
    ...
    public boolean pageScroll(int i) {
        ...
        if (z) {
            ...
            if (childCount > 0) {
                ...
                int bottom = ((LayoutParams) childAt.getLayoutParams()).bottomMargin + childAt.getBottom() + getPaddingBottom();
    ...
    public boolean arrowScroll(int i) {
        ...
        if (findNextFocus == null || !isWithinDeltaOfScreen(findNextFocus, maxScrollAmount, getHeight())) {
            if (i == 33 && getScrollY() < maxScrollAmount) {
                ...
                View childAt = getChildAt(0);
                LayoutParams layoutParams = (LayoutParams) childAt.getLayoutParams();
                i2 = Math.min((layoutParams.bottomMargin + childAt.getBottom()) - ((getScrollY() + getHeight()) - getPaddingBottom()), maxScrollAmount);
            }
            if (i2 == 0) {
                return false;
            }
    ...
    public int computeScrollDeltaToGetChildRectOnScreen(Rect rect) {
        ...
        if (rect.bottom < childAt.getHeight() + layoutParams.topMargin + layoutParams.bottomMargin) {
            i2 = i6 - verticalFadingEdgeLength;
        } else {
            i2 = i6;
        }
        if (rect.bottom > i2 && rect.top > i) {
            if (rect.height() > height) {
                i5 = (rect.top - i) + 0;
            } else {
                i5 = (rect.bottom - i2) + 0;
            }
            i3 = Math.min(i5, (layoutParams.bottomMargin + childAt.getBottom()) - i6);
        } else if (rect.top >= i || rect.bottom >= i2) {
            i3 = 0;
        } else {
            if (rect.height() > height) {
                i4 = 0 - (i2 - rect.bottom);
        ...
        if (this.mEdgeGlowTop != null) {
            ...
            if (!this.mEdgeGlowTop.isFinished()) {
                ...
                if (VERSION.SDK_INT < 21 || getClipToPadding()) {
                    i = width - (getPaddingLeft() + getPaddingRight());
                    i2 = getPaddingLeft() + 0;
                } else {
                    i = width;
                    i2 = 0;
                ...
                this.mEdgeGlowTop.setSize(i, height);
