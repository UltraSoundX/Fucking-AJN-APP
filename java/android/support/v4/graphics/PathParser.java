...
public class PathParser {
            ...
            while (i2 < fArr2.length) {
                switch (c2) {
                    case 'A':
                        ...
                        drawArc(path, f22, f21, f23, f24, f25, f26, f27, z3, z);
                    ...
                    case 'a':
                        ...
                        drawArc(path, f22, f21, f40, f41, f42, f43, f44, z4, z2);
    ...
    private static float[] getFloats(String str) {
        ...
        try {
            ...
            throw new RuntimeException("error in parsing \"" + str + JSONUtils.DOUBLE_QUOTE, e);
        }
    }
