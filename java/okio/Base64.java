...
final class Base64 {
    ...
    private static String encode(byte[] bArr, byte[] bArr2) {
        ...
        while (i2 < length) {
            ...
            int i4 = i3 + 1;
            bArr3[i3] = bArr2[((bArr[i2] & 3) << 4) | ((bArr[i2 + 1] & DeviceInfos.NETWORK_TYPE_UNCONNECTED) >> 4)];
            int i5 = i4 + 1;
            bArr3[i4] = bArr2[((bArr[i2 + 1] & 15) << 2) | ((bArr[i2 + 2] & DeviceInfos.NETWORK_TYPE_UNCONNECTED) >> 6)];
            int i6 = i5 + 1;
        ...
        switch (bArr.length % 3) {
            case 1:
                ...
                int i8 = i7 + 1;
                bArr3[i7] = bArr2[(bArr[length] & 3) << 4];
                int i9 = i8 + 1;
                bArr3[i8] = 61;
                i = i9 + 1;
                bArr3[i9] = 61;
            ...
            case 2:
                ...
                bArr3[i] = bArr2[(bArr[length] & DeviceInfos.NETWORK_TYPE_UNCONNECTED) >> 2];
                int i11 = i10 + 1;
                bArr3[i10] = bArr2[((bArr[length] & 3) << 4) | ((bArr[length + 1] & DeviceInfos.NETWORK_TYPE_UNCONNECTED) >> 4)];
                int i12 = i11 + 1;
