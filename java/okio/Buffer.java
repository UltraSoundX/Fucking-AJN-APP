...
public final class Buffer implements Cloneable, BufferedSink, BufferedSource {
        ...
        return new InputStream() {
            public int read() {
                if (Buffer.this.size > 0) {
                    return Buffer.this.readByte() & DeviceInfos.NETWORK_TYPE_UNCONNECTED;
                }
                return -1;
            }
    ...
    public Buffer writeUtf8CodePoint(int i) {
        if (i < 128) {
            ...
            if (i < 55296 || i > 57343) {
                writeByte((i >> 12) | ErrorCode.EXCEED_INCR_UPDATE);
            ...
            writeByte((i >> 18) | ErrorCode.TPATCH_VERSION_FAILED);
    ...
    public Buffer writeDecimalLong(long j) {
        ...
        int i = j2 < 100000000 ? j2 < OkHttpUtils.DEFAULT_MILLISECONDS ? j2 < 100 ? j2 < 10 ? 1 : 2 : j2 < 1000 ? 3 : 4 : j2 < 1000000 ? j2 < 100000 ? 5 : 6 : j2 < 10000000 ? 7 : 8 : j2 < 1000000000000L ? j2 < 10000000000L ? j2 < 1000000000 ? 9 : 10 : j2 < 100000000000L ? 11 : 12 : j2 < 1000000000000000L ? j2 < 10000000000000L ? 13 : j2 < 100000000000000L ? 14 : 15 : j2 < 100000000000000000L ? j2 < 10000000000000000L ? 16 : 17 : j2 < 1000000000000000000L ? 18 : 19;
        if (z) {
            i++;
        }
