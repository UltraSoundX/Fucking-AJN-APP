...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        private static String canonicalizeHost(String str, int i, int i2) {
            ...
            if (!percentDecode.contains(Config.TRACE_TODAY_VISIT_SPLIT)) {
        ...
        private static String inet6AddressToAscii(byte[] bArr) {
            ...
            while (i < bArr.length) {
                if (i == i3) {
                    ...
                    buffer.writeHexadecimalUnsignedLong((long) (((bArr[i] & DeviceInfos.NETWORK_TYPE_UNCONNECTED) << 8) | (bArr[i + 1] & DeviceInfos.NETWORK_TYPE_UNCONNECTED)));
                    i += 2;
                }
            }
            ...
            if (!z || !(codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13)) {
                if (codePointAt == 43 && z3) {
                    ...
                    while (!buffer2.exhausted()) {
                        byte readByte = buffer2.readByte() & DeviceInfos.NETWORK_TYPE_UNCONNECTED;
                        buffer.writeByte(37);
