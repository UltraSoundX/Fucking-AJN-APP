...
public final class Cookie {
    ...
    static Cookie parse(long j, HttpUrl httpUrl, String str) {
        ...
        while (i < length) {
            ...
            String str6 = delimiterOffset4 < delimiterOffset3 ? Util.trimSubstring(str, delimiterOffset4 + 1, delimiterOffset3) : "";
            if (trimSubstring3.equalsIgnoreCase("expires")) {
                try {
                    j3 = parseExpires(str6, 0, str6.length());
                    z4 = true;
                    str3 = str4;
                ...
                if (trimSubstring3.equalsIgnoreCase("max-age")) {
                    ...
                    if (trimSubstring3.equalsIgnoreCase("domain")) {
                        try {
                            str3 = parseDomain(str6);
                            z3 = false;
                        } catch (IllegalArgumentException e3) {
                            str3 = str4;
                        }
                    } else {
                        if (trimSubstring3.equalsIgnoreCase(Config.FEED_LIST_ITEM_PATH)) {
                            str5 = str6;
                            str3 = str4;
                        } else {
        ...
        if (str4 == null) {
            str4 = httpUrl.host();
        } else if (!domainMatch(httpUrl, str4)) {
            return null;
        }
