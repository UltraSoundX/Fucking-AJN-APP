...
public class f extends SQLiteOpenHelper {
    protected static final String[] a = {SettingsContentProvider.KEY};
    ...
    public synchronized java.util.List<java.io.Serializable> a(java.lang.String r12) {
        ...
        L_0x0094:
            ...
            com.tencent.open.a.f.a(r3, r4, r1)     // Catch:{ all -> 0x00db }
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            if (writableDatabase != null) {
                try {
                    ...
                    com.tencent.open.a.f.a("openSDK_LOG.ReportDatabaseHelper", "clearReportItem has exception.", e);
                    if (writableDatabase != null) {
                        writableDatabase.close();
                    }
                } catch (Throwable th) {
