...
public class g {
                ...
                this.g.execute(new Runnable() {
                    public void run() {
                        try {
                            ...
                            bundle.putString(MidEntity.TAG_IMEI, c.b(d.a()));
                            bundle.putString(MidEntity.TAG_IMSI, c.c(d.a()));
                            bundle.putString("android_id", c.d(d.a()));
                            bundle.putString(MidEntity.TAG_MAC, c.a());
                            bundle.putString("platform", "1");
                            bundle.putString("os_ver", VERSION.RELEASE);
                            bundle.putString("position", j.b(d.a()));
                            ...
                            bundle.putString("qz_ver", j.d(d.a(), TbsConfig.APP_QZONE));
                            bundle.putString("qq_ver", j.c(d.a(), TbsConfig.APP_QQ));
                            bundle.putString("qua", j.e(d.a(), d.b()));
                            bundle.putString("packagename", d.b());
                            bundle.putString("app_ver", j.d(d.a(), d.b()));
                            if (bundle != null) {
                            ...
                            if (g.this.a("report_via", size) || z) {
                                g.this.e();
                                g.this.f.removeMessages(PointerIconCompat.TYPE_CONTEXT_MENU);
                            } else if (!g.this.f.hasMessages(PointerIconCompat.TYPE_CONTEXT_MENU)) {
                                Message obtain = Message.obtain();
                                obtain.what = PointerIconCompat.TYPE_CONTEXT_MENU;
                                g.this.f.sendMessageDelayed(obtain, (long) a2);
                            }
                        } catch (Exception e) {
                            f.a("openSDK_LOG.ReportManager", "--> reporVia, exception in sub thread.", e);
                        }
                    }
                });
            }
            ...
            this.h.execute(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        f.a("openSDK_LOG.ReportManager", "--> reportCGI, exception in sub thread.", e2);
                    }
                }
            });
        }
    ...
    public void b() {
        this.h.execute(new Runnable() {
            ...
            public void run() {
                ...
                L_0x000a:
                    android.content.Context r0 = com.tencent.open.d.d.a()     // Catch:{ Exception -> 0x00b2 }
                    r2 = 0     // Catch:{ Exception -> 0x00b2 }
                    com.tencent.open.d.e r0 = com.tencent.open.d.e.a(r0, r2)     // Catch:{ Exception -> 0x00b2 }
                ...
                L_0x0036:
                    int r0 = r0 + 1
                    android.content.Context r2 = com.tencent.open.d.d.a()     // Catch:{ ConnectTimeoutException -> 0x00bf, SocketTimeoutException -> 0x00ca, Exception -> 0x00d3 }
                    r5 = 0     // Catch:{ ConnectTimeoutException -> 0x00bf, SocketTimeoutException -> 0x00ca, Exception -> 0x00d3 }
                    java.lang.String r6 = "https://wspeed.qq.com/w.cgi"     // Catch:{ ConnectTimeoutException -> 0x00bf, SocketTimeoutException -> 0x00ca, Exception -> 0x00d3 }
                    org.apache.http.client.HttpClient r2 = com.tencent.open.d.a.a(r2, r5, r6)     // Catch:{ ConnectTimeoutException -> 0x00bf, SocketTimeoutException -> 0x00ca, Exception -> 0x00d3 }
                    ...
                    java.lang.String r6 = com.tencent.open.d.a.a(r4)     // Catch:{ ConnectTimeoutException -> 0x00bf, SocketTimeoutException -> 0x00ca, Exception -> 0x00d3 }
                    byte[] r6 = com.tencent.open.d.j.h(r6)     // Catch:{ ConnectTimeoutException -> 0x00bf, SocketTimeoutException -> 0x00ca, Exception -> 0x00d3 }
    ...
    public Bundle c() {
        ...
        try {
            ...
            bundle.putString("releaseversion", "OpenSdk_3.3.5.lite");
            bundle.putString(Config.DEVICE_PART, Build.DEVICE);
            bundle.putString("qua", "V1_AND_OpenSDK_3.3.5.lite_1077_RDM_B");
            bundle.putString(SettingsContentProvider.KEY, "apn,frequency,commandid,resultcode,tmcost,reqsize,rspsize,detail,touin,deviceinfo");
            ...
            f.a("openSDK_LOG.ReportManager", "-->prepareCgiData, exception.", e2);
            return null;
        }
    }
    ...
    public Bundle d() {
        ...
        try {
            ...
            f.a("openSDK_LOG.ReportManager", "-->prepareViaData, put bundle to json array exception", e3);
            return null;
        }
    }
  ...
  PHI: (r10v9 int) = (r10v2 int), (r10v2 int), (r10v16 int), (r10v16 int), (r10v2 int) binds: [B:7:0x0038, B:8:?, B:18:0x005e, B:19:?, B:13:0x0052] A[DONT_GENERATE, DONT_INLINE], Splitter:B:7:0x0038] */
            /* JADX WARNING: Removed duplicated region for block: B:41:0x00d2 A[Catch:{ Exception -> 0x00a3 }, ExcHandler: b (e com.tencent.open.d.a$b), Splitter:B:7:0x0038] */
            /* JADX WARNING: Removed duplicated region for block: B:43:0x00e5 A[ExcHandler: a (r10v7 'e' com.tencent.open.d.a$a A[CUSTOM_DECLARE]), Splitter:B:7:0x0038] */
  ...
  PHI: (r3v7 boolean) = (r3v6 boolean), (r3v6 boolean), (r3v6 boolean), (r3v26 boolean), (r3v26 boolean), (r3v6 boolean), (r3v6 boolean) binds: [B:7:0x0038, B:8:?, B:10:0x004c, B:18:0x005e, B:19:?, B:13:0x0052, B:11:?] A[DONT_GENERATE, DONT_INLINE], Splitter:B:7:0x0038] */
            ...
            public void run() {
                ...
                L_0x0036:
                    int r10 = r10 + 1
                    android.content.Context r12 = com.tencent.open.d.d.a()     // Catch:{ ConnectTimeoutException -> 0x00b0, SocketTimeoutException -> 0x00c0, JSONException -> 0x00cb, b -> 0x00d2, a -> 0x00e5, IOException -> 0x0104, Exception -> 0x010f }
                    java.lang.String r13 = "https://appsupport.qq.com/cgi-bin/appstage/mstats_batch_report"
                    java.lang.String r15 = "POST"
                    com.tencent.open.d.j$a r15 = com.tencent.open.d.a.a(r12, r13, r15, r14)     // Catch:{ ConnectTimeoutException -> 0x00b0, SocketTimeoutException -> 0x00c0, JSONException -> 0x00cb, b -> 0x00d2, a -> 0x00e5, IOException -> 0x0104, Exception -> 0x010f }
                    java.lang.String r12 = r15.a     // Catch:{ ConnectTimeoutException -> 0x00b0, SocketTimeoutException -> 0x00c0, JSONException -> 0x00cb, b -> 0x00d2, a -> 0x00e5, IOException -> 0x0104, Exception -> 0x010f }
                    org.json.JSONObject r12 = com.tencent.open.d.j.c(r12)     // Catch:{ ConnectTimeoutException -> 0x00b0, SocketTimeoutException -> 0x00c0, JSONException -> 0x00cb, b -> 0x00d2, a -> 0x00e5, IOException -> 0x0104, Exception -> 0x010f }
                    java.lang.String r13 = "ret"
                    int r12 = r12.getInt(r13)     // Catch:{ JSONException -> 0x00ad, ConnectTimeoutException -> 0x00b0, SocketTimeoutException -> 0x00c0, b -> 0x00d2, a -> 0x00e5, IOException -> 0x0104, Exception -> 0x010f }
                L_0x0050:
                    if (r12 == 0) goto L_0x005a
                    java.lang.String r12 = r15.a     // Catch:{ ConnectTimeoutException -> 0x00b0, SocketTimeoutException -> 0x00c0, JSONException -> 0x00cb, b -> 0x00d2, a -> 0x00e5, IOException -> 0x0104, Exception -> 0x010f }
                    boolean r12 = android.text.TextUtils.isEmpty(r12)     // Catch:{ ConnectTimeoutException -> 0x00b0, SocketTimeoutException -> 0x00c0, JSONException -> 0x00cb, b -> 0x00d2, a -> 0x00e5, IOException -> 0x0104, Exception -> 0x010f }
                    if (r12 != 0) goto L_0x005c
                L_0x005a:
                    r3 = 1
                    r10 = r11
                L_0x005c:
                    long r12 = r15.b     // Catch:{ ConnectTimeoutException -> 0x00b0, SocketTimeoutException -> 0x00c0, JSONException -> 0x00cb, b -> 0x00d2, a -> 0x00e5, IOException -> 0x0104, Exception -> 0x010f }
                    long r4 = r15.c     // Catch:{ ConnectTimeoutException -> 0x00b0, SocketTimeoutException -> 0x00c0, JSONException -> 0x00cb, b -> 0x00d2, a -> 0x012b, IOException -> 0x0104, Exception -> 0x010f }
                    r6 = r12
                L_0x0061:
                ...
                L_0x00a3:
                    ...
                    com.tencent.open.a.f.a(r3, r4, r2)
                    goto L_0x000a
                L_0x00ad:
                    r12 = move-exception
                    r12 = -4
                ...
                L_0x0104:
                    ...
                    r6 = 0
                    r4 = 0
                    int r2 = com.tencent.open.d.a.a(r2)     // Catch:{ Exception -> 0x00a3 }
                    goto L_0x0061
                L_0x010f:
                    r2 = move-exception
                    r6 = 0
        ...
        h.a(new Runnable() {
            ...
            public void run() {
                ...
                L_0x0016:
                    ...
                    android.content.Context r1 = com.tencent.open.d.d.a()     // Catch:{ Exception -> 0x00b5 }
                    r3 = 0
                    java.lang.String r5 = r3     // Catch:{ Exception -> 0x00b5 }
                    org.apache.http.client.HttpClient r5 = com.tencent.open.d.a.a(r1, r3, r5)     // Catch:{ Exception -> 0x00b5 }
                    android.os.Bundle r1 = r2     // Catch:{ Exception -> 0x00b5 }
                    java.lang.String r1 = com.tencent.open.d.a.a(r1)     // Catch:{ Exception -> 0x00b5 }
                ...
                L_0x00c2:
                    ...
                    byte[] r3 = com.tencent.open.d.j.h(r3)     // Catch:{ Exception -> 0x00b5 }
