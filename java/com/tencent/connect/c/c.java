...
public class c {
    public static final void a(Context context, final String str, final com.tencent.open.d.c cVar) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            new Thread(new Runnable() {
                public void run() {
                    String a2;
                    Bitmap a3 = c.a(str, (int) ErrorCode.NEEDDOWNLOAD_1);
                    if (a3 != null) {
                        String str = Environment.getExternalStorageDirectory() + "/tmp/";
                        String str2 = "share2qq_temp" + j.e(str) + ".jpg";
                        if (!c.b(str, (int) ErrorCode.NEEDDOWNLOAD_1, (int) ErrorCode.NEEDDOWNLOAD_1)) {
    ...
    public static final void a(Context context, final ArrayList<String> arrayList, final com.tencent.open.d.c cVar) {
            ...
            public void run() {
                ...
                while (true) {
                    ...
                    if (i2 < arrayList.size()) {
                        ...
                        if (!j.f(str) && j.g(str)) {
                            Bitmap a2 = c.a(str, 10000);
                            if (a2 != null) {
                                String str2 = Environment.getExternalStorageDirectory() + "/tmp/";
                                String str3 = "share2qzone_temp" + j.e(str) + ".jpg";
                                if (!c.b(str, 640, 10000)) {
                                    f.b("openSDK_LOG.AsynScaleCompressImage", "not out of bound,not compress!");
                                } else {
                                    f.b("openSDK_LOG.AsynScaleCompressImage", "out of bound, compress!");
                                    str = c.a(a2, str2, str3);
                                }
                                if (str != null) {
