...
public class TbsCoreLoadStat {
    ...
    public class TbsSequenceQueue {
        ...
        public String toString() {
            ...
            for (int i = this.e; i < this.f; i++) {
                sb.append(String.valueOf(this.d[i]) + StorageInterface.KEY_SPLITER);
            }
    ...
    public synchronized void a(Context context, int i, Throwable th) {
        if (mLoadErrorCode == -1) {
            ...
            StringBuilder sb = new StringBuilder("setLoadErrorCode :: error(");
            sb.append(mLoadErrorCode);
            sb.append(") was already reported; ");
            sb.append(i);
            sb.append(" is duplicated. Try to remove it!");
            TbsLog.w("TbsCoreLoadStat", sb.toString());
        }
    }
}
