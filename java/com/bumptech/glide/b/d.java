...
public class d {
    ...
    private void g() {
        do {
            l();
            if (this.a[0] == 1) {
                this.c.m = (this.a[1] & DeviceInfos.NETWORK_TYPE_UNCONNECTED) | ((this.a[2] & DeviceInfos.NETWORK_TYPE_UNCONNECTED) << 8);
            }
            if (this.d <= 0) {
                return;
            }
    ...
    private int[] a(int r11) {
        ...
        L_0x0047:
            com.bumptech.glide.b.c r1 = r10.c
            r2 = 1
            r1.b = r2
        L_0x004c:
            return r0
    ...
    private int m() {
        boolean z = false;
        try {
            return this.b.get() & DeviceInfos.NETWORK_TYPE_UNCONNECTED;
        } catch (Exception e) {
            this.c.b = 1;
            return z;
        }
