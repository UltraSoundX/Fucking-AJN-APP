        ...
        if (bitmap.getWidth() != i || bitmap.getHeight() != i2) {
            ...
            if (bitmap.getWidth() != width || bitmap.getHeight() != height) {
                ...
                if (Log.isLoggable("TransformationUtils", 2)) {
                    Log.v("TransformationUtils", "request: " + i + com.baidu.mobstat.Config.EVENT_HEAT_X + i2);
                    Log.v("TransformationUtils", "toFit:   " + bitmap.getWidth() + com.baidu.mobstat.Config.EVENT_HEAT_X + bitmap.getHeight());
                    Log.v("TransformationUtils", "toReuse: " + a2.getWidth() + com.baidu.mobstat.Config.EVENT_HEAT_X + a2.getHeight());
