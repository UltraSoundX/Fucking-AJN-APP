...
public class CommonTabLayout extends FrameLayout implements AnimatorUpdateListener {
    ...
    public CommonTabLayout(Context context, AttributeSet attributeSet, int i2) {
        ...
        if (!attributeValue.equals(ERROR.CMD_FORMAT_ERROR) && !attributeValue.equals(ERROR.CMD_NO_CMD)) {
    ...
    private void a(Context context, AttributeSet attributeSet) {
        ...
        this.f418q = obtainStyledAttributes.getColor(R.styleable.CommonTabLayout_tl_indicator_color, Color.parseColor(this.m == 2 ? "#4B6A87" : "#ffffff"));
    ...
    private void a(int i2, View view) {
        ((TextView) view.findViewById(R.id.tv_tab_title)).setText(((com.flyco.tablayout.a.a) this.b.get(i2)).getTabTitle());
        ((ImageView) view.findViewById(R.id.iv_tab_icon)).setImageResource(((com.flyco.tablayout.a.a) this.b.get(i2)).getTabUnselectedIcon());
    ...
    private void b() {
        ...
        while (i2 < this.f) {
            ...
            if (this.N) {
                ...
                imageView.setImageResource(i2 == this.d ? aVar.getTabSelectedIcon() : aVar.getTabUnselectedIcon());
