...
public class SegmentTabLayout extends FrameLayout implements AnimatorUpdateListener {
    ...
    private void a(Context context, AttributeSet attributeSet) {
        ...
        this.f419q = obtainStyledAttributes.getDimension(R.styleable.SegmentTabLayout_tl_indicator_margin_left, (float) a(0.0f));
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (!isInEditMode() && this.f > 0) {
            ...
            this.h.setBounds(((int) this.f419q) + paddingLeft + this.g.left, (int) this.r, (int) (((float) (this.g.right + paddingLeft)) - this.s), (int) (this.r + this.o));
