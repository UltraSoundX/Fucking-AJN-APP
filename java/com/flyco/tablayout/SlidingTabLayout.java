...
public class SlidingTabLayout extends HorizontalScrollView implements OnPageChangeListener {
    ...
    private void a(Context context, AttributeSet attributeSet) {
        ...
        this.f420q = obtainStyledAttributes.getBoolean(R.styleable.SlidingTabLayout_tl_tab_space_equal, false);
        this.r = obtainStyledAttributes.getDimension(R.styleable.SlidingTabLayout_tl_tab_width, (float) a(-1.0f));
        this.p = obtainStyledAttributes.getDimension(R.styleable.SlidingTabLayout_tl_tab_padding, (this.f420q || this.r > 0.0f) ? (float) a(0.0f) : (float) a(20.0f));
        obtainStyledAttributes.recycle();
    }
    ...
    private void a(int i2, String str, View view) {
        ...
        LayoutParams layoutParams = this.f420q ? new LayoutParams(0, -1, 1.0f) : new LayoutParams(-2, -1);
        if (this.r > 0.0f) {
