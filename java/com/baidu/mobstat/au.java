...
public final class au {
    ...
    public static String a(byte[] bArr, String str) throws UnsupportedEncodingException {
        ...
        while (i3 < length2) {
            int i5 = i4 + 1;
            bArr2[i4] = a[(bArr[i3] & DeviceInfos.NETWORK_TYPE_UNCONNECTED) >> 2];
            int i6 = i5 + 1;
            bArr2[i5] = a[((bArr[i3] & 3) << 4) | ((bArr[i3 + 1] & DeviceInfos.NETWORK_TYPE_UNCONNECTED) >> 4)];
            int i7 = i6 + 1;
            bArr2[i6] = a[((bArr[i3 + 1] & 15) << 2) | ((bArr[i3 + 2] & DeviceInfos.NETWORK_TYPE_UNCONNECTED) >> 6)];
            int i8 = i7 + 1;
        ...
        switch (bArr.length % 3) {
            case 1:
                int i9 = i4 + 1;
                bArr2[i4] = a[(bArr[length2] & DeviceInfos.NETWORK_TYPE_UNCONNECTED) >> 2];
                int i10 = i9 + 1;
