...
public class e extends cn.sharesdk.framework.authorize.e implements ServiceConnection {
    ...
    public void a() {
        ...
        try {
            z = StubApp.getOrigApplicationContext(this.a.getContext().getApplicationContext()).bindService(intent, this, 1);
        } catch (Throwable th) {
            z = false;
        }
        if (!z) {
    ...
    private boolean a(String str, String str2) {
        ...
        if (this.f != null && this.f.length > 0) {
            intent.putExtra("scope", TextUtils.join(StorageInterface.KEY_SPLITER, this.f));
        }
        if (!b(intent)) {
            return false;
        }
        ...
        StubApp.getOrigApplicationContext(this.a.getContext().getApplicationContext()).unbindService(this);
        return z;
    }
